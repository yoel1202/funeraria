Public Class Reporte_de_recibos_Recaudados_University
    Public contrato As String
    Public fecha1 As Date
    Public fecha2 As Date
    Private Sub Reporte_de_recibos_Recaudados_University_Load(sender As Object, e As EventArgs) Handles MyBase.Load

        Dim reporte As New Reporte_de_recibos_Recaudados_University_RPT
        If (contrato = 0) Then
